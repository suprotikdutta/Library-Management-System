...
public class AddJournal extends JFrame implements ActionListener{
	...
	JLabel l6 = new JLabel("Journal_id");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(138, 43, 226), 2), "Add Journals", TitledBorder.LEADING,
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            conn con = new conn();
            if(ae.getSource() == b1){
                String sql = "insert into book(book_id, name, isbn, publisher, edition, price, pages, bflag) values(?, ?, ?, ?, ?, ?, ?, ?)";
