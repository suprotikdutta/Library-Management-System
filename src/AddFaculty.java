...
public class AddFaculty extends JFrame implements ActionListener{
	...
	JLabel l1 = new JLabel("Faculty_id");
...
/*	t3 = new JTextField();
    ...
    */    
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "CSE", "IT", "CE", "ME", "EE", "AEIE" }));
...
**/
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(102, 205, 170), 2, true), "Add-Faculty",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                try{
                conn con = new conn();
                String sql = "insert into member(member_id, name, father, course, branch, year, semester, mflag) values(?, ?, ?, ?, ?, ?, ?, ?)";
